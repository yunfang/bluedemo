...
import com.uyu.device.library.R;
...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bid = getSharePreferenceValue();
        if(bid != null){
            tvMsg.setText("please click:"+bid);
    ...
    public String getSharePreferenceValue(){
        SharedPreferences pref = getSharedPreferences("pref_device_info", Context.MODE_PRIVATE);
        return pref.getString("pref_connect_bluetooth_uid","");
    }
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
	        ...
	        if(!((TextView) v).getText().toString().equals(strNoFound)) {
	            ...
	            intent.putExtra(com.uyu.device.library.BluetoothState.EXTRA_DEVICE_ADDRESS, address);
